...
class DeleteProjectOperationImpl implements DeleteProjectOperation {
    ...
    static private final String sql = """
            delete from $schema.tab_tenant_project where uuid = $1
            """;
    ...
    public Uni<Boolean> deleteProject(final SqlConnection sqlConnection,
        ...
        return sqlConnection.preparedQuery(preparedSql)
                ...
                .invoke(deleted -> {
                    if (deleted) {
                        log.info("Project was deleted, shard={}, uuid={}", shard, uuid);
                    } else {
                        log.warn("Project was not found, skip operation, shard={}, uuid={}", shard, uuid);
                    }
                });
    }
}
