...
class DeleteTenantOperationImpl implements DeleteTenantOperation {
    ...
    static private final String sql = """
            delete from $schema.tab_tenant where uuid = $1
            """;
    ...
    public Uni<Boolean> deleteTenant(final SqlConnection sqlConnection,
        ...
        return sqlConnection.preparedQuery(preparedSql)
                ...
                .invoke(deleted -> {
                    if (deleted) {
                        log.info("Tenant was deleted, shard={}, uuid={}", shard, uuid);
                    } else {
                        log.warn("Tenant was not found, skip operation, shard={}, uuid={}", shard, uuid);
                    }
                });
    }
}
