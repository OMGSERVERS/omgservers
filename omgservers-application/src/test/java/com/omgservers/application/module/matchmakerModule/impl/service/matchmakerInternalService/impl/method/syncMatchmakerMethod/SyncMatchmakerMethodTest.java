...
class SyncMatchmakerMethodTest extends Assertions {
    ...
    void givenMatchmaker_whenSyncMatchmaker_thenEventInsertedAndEntityCreated() {
        ...
        final var syncMatchmakerInternalRequest = new SyncMatchmakerShardRequest(matchmaker1);
...
//
//        final var getMatchmakerInternalRequest = new GetMatchmakerShardRequest(matchmaker1.getId());
