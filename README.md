...
OMGSERVERS is a backend platform for developing, testing, and running authoritative servers for online games.
...
| OMGSERVERS_INITIALIZATION_SERVER_INDEX_SERVERS_`<index>`: `http://service:8080` |
