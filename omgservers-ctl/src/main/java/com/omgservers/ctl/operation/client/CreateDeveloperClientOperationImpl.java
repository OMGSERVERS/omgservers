...
@Slf4j
@ApplicationScoped
class CreateDeveloperClientOperationImpl implements CreateDeveloperClientOperation {

    @Override
    public DeveloperClient execute(final URI uri, final String bearerToken) {
