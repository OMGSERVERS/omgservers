...
import com.omgservers.service.service.room.dto.IncomingRuntimeMessageDto;
import com.omgservers.service.service.room.dto.MessageEncodingEnum;
import com.omgservers.service.service.room.dto.OutgoingRuntimeMessageDto;
...
@ApplicationScoped
@AllArgsConstructor
class HandleWebSocketMessageOperationImpl implements HandleWebSocketMessageOperation {
    ...
    public Uni<Void> execute(final WebSocketConnection webSocketConnection,
        ...
        // TODO: throws errors in the else blocks
