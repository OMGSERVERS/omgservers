package com.omgservers.service.server.task.impl;

import com.omgservers.service.server.task.TaskService;
import com.omgservers.service.server.task.dto.*;
import com.omgservers.service.server.task.dto.ExecuteEventHandlerTaskRequest;
import com.omgservers.service.server.task.impl.method.executeBootstrapTask.ExecuteBootstrapTaskMethod;
import com.omgservers.service.server.task.impl.method.executeMatchmakerTask.ExecuteMatchmakerTaskMethod;
import com.omgservers.service.server.task.impl.method.executePoolTask.ExecutePoolTaskMethod;
import com.omgservers.service.server.task.impl.method.executeDeploymentTask.ExecuteDeploymentTaskMethod;
import com.omgservers.service.server.task.impl.method.executeEventHandlerTask.ExecuteEventHandlerTaskMethod;
import com.omgservers.service.server.task.impl.method.executeRuntimeTask.ExecuteRuntimeTaskMethod;
import com.omgservers.service.server.task.impl.method.executeSchedulerTask.ExecuteSchedulerTaskMethod;
import com.omgservers.service.server.task.impl.method.executeStageTask.ExecuteStageTaskMethod;
import com.omgservers.service.server.task.impl.method.executeTenantTask.ExecuteTenantTaskMethod;
