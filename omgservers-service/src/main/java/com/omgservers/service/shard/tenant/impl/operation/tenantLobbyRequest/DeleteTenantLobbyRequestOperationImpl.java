...
@ApplicationScoped
@AllArgsConstructor
class DeleteTenantLobbyRequestOperationImpl implements DeleteTenantLobbyRequestOperation {
    ...
    public Uni<Boolean> execute(final ChangeContext<?> changeContext,
        ...
        return changeObjectOperation.changeObject(
                ...
                """
                        update $schema.tab_tenant_lobby_request
                ...
                () -> new TenantLobbyRequestDeletedEventBodyModel(tenantId, id),
                () -> null
        );
    }
}
