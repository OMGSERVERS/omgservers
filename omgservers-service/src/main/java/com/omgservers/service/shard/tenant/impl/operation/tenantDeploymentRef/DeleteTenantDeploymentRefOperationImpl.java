...
@ApplicationScoped
@AllArgsConstructor
class DeleteTenantDeploymentRefOperationImpl implements DeleteTenantDeploymentRefOperation {
    ...
    public Uni<Boolean> execute(final ChangeContext<?> changeContext,
        ...
        return changeObjectOperation.changeObject(
                ...
                """
                        update $schema.tab_tenant_deployment_ref
                ...
                () -> new TenantDeploymentRefDeletedEventBodyModel(tenantId, id),
                () -> null
        );
    }
}
