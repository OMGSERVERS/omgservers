...
@ApplicationScoped
@AllArgsConstructor
class DeleteDeploymentMatchmakerAssignmentOperationImpl implements DeleteDeploymentMatchmakerAssignmentOperation {
    ...
    public Uni<Boolean> execute(final ChangeContext<?> changeContext,
        ...
        return changeObjectOperation.changeObject(
                ...
                """
                        update $schema.tab_deployment_matchmaker_assignment
                ...
                () -> new DeploymentMatchmakerAssignmentDeletedEventBodyModel(deploymentId, id),
                () -> null
        );
    }
}
