...
@ApplicationScoped
@AllArgsConstructor
class DeleteTenantDeploymentResourceOperationImpl implements DeleteTenantDeploymentResourceOperation {
    ...
    public Uni<Boolean> execute(final ChangeContext<?> changeContext,
        ...
        return changeObjectOperation.changeObject(
                ...
                """
                        update $schema.tab_tenant_deployment_resource
                ...
                () -> new TenantDeploymentResourceDeletedEventBodyModel(tenantId, id),
                () -> null
        );
    }
}
