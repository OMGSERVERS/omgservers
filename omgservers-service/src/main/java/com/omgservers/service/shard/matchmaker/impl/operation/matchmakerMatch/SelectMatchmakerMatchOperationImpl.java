...
import com.omgservers.service.shard.matchmaker.impl.mappers.MatchmakerMatchModelMapper;
...
class SelectMatchmakerMatchOperationImpl implements SelectMatchmakerMatchOperation {
    ...
    @Override
    public Uni<MatchmakerMatchModel> execute(final SqlConnection sqlConnection,
                                             final int shard,
        ...
        return selectObjectOperation.selectObject(
                ...
                "Matchmaker match",
                matchmakerMatchModelMapper::execute);
    }
}
