...
@ApplicationScoped
@AllArgsConstructor
class DeleteTenantImageOperationImpl implements DeleteTenantImageOperation {
    ...
    public Uni<Boolean> execute(final ChangeContext<?> changeContext,
        ...
        return changeObjectOperation.execute(
                ...
                () -> new TenantImageDeletedEventBodyModel(tenantId, id),
                () -> null
        );
    }
}
