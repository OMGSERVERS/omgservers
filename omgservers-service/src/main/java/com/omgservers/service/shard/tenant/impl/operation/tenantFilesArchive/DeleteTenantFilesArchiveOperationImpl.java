...
@ApplicationScoped
@AllArgsConstructor
class DeleteTenantFilesArchiveOperationImpl implements DeleteTenantFilesArchiveOperation {
    ...
    public Uni<Boolean> execute(final ChangeContext<?> changeContext,
        ...
        return changeObjectOperation.changeObject(
                ...
                """
                        update $schema.tab_tenant_files_archive
                ...
                () -> new TenantFilesArchiveDeletedEventBodyModel(tenantId, id),
                () -> null
        );
    }
}
