...
@ApplicationScoped
@AllArgsConstructor
class DeleteDeploymentLobbyAssignmentOperationImpl implements DeleteDeploymentLobbyAssignmentOperation {
    ...
    public Uni<Boolean> execute(final ChangeContext<?> changeContext,
        ...
        return changeObjectOperation.execute(
                ...
                () -> new DeploymentLobbyAssignmentDeletedEventBodyModel(deploymentId, id),
                () -> null
        );
    }
}
