...
@ApplicationScoped
@AllArgsConstructor
class DeleteTenantMatchmakerResourceOperationImpl implements DeleteTenantMatchmakerResourceOperation {
    ...
    public Uni<Boolean> execute(final ChangeContext<?> changeContext,
        ...
        return changeObjectOperation.changeObject(
                ...
                () -> new TenantMatchmakerResourceDeletedEventBodyModel(tenantId, id),
                () -> null
        );
    }
}
