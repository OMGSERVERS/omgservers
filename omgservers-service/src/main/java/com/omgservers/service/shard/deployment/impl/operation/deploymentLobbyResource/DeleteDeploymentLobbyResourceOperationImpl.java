...
@ApplicationScoped
@AllArgsConstructor
class DeleteDeploymentLobbyResourceOperationImpl implements DeleteDeploymentLobbyResourceOperation {
    ...
    public Uni<Boolean> execute(final ChangeContext<?> changeContext,
        ...
        return changeObjectOperation.execute(
                ...
                """
                        update $slot.tab_deployment_lobby_resource
                ...
                () -> new DeploymentLobbyResourceDeletedEventBodyModel(deploymentId, id),
                () -> null
        );
    }
}
