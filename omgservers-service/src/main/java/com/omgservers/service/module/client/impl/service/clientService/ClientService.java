...
public interface ClientService {
    ...
    Uni<HandleMessageResponse> handleMessage(@Valid HandleMessageRequest request);

    Uni<ReceiveMessagesResponse> receiveMessages(@Valid ReceiveMessagesRequest request);
