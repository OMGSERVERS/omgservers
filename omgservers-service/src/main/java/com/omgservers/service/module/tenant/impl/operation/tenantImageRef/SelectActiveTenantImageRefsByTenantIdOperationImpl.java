...
@ApplicationScoped
@AllArgsConstructor
class SelectActiveTenantImageRefsByTenantIdOperationImpl implements SelectActiveTenantImageRefsByTenantIdOperation {
    ...
    @Override
    public Uni<List<TenantImageRefModel>> execute(final SqlConnection sqlConnection,
                                                  final int shard,
                                                  final Long tenantId) {
