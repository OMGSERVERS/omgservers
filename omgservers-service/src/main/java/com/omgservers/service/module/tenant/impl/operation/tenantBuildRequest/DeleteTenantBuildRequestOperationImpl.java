...
@ApplicationScoped
@AllArgsConstructor
class DeleteTenantBuildRequestOperationImpl implements DeleteTenantBuildRequestOperation {
    ...
    public Uni<Boolean> execute(final ChangeContext<?> changeContext,
        ...
        return changeObjectOperation.changeObject(
                ...
                """
                        update $schema.tab_tenant_build_request
                ...
                () -> new TenantBuildRequestDeletedEventBodyModel(tenantId, id),
                () -> null
        );
    }
}
