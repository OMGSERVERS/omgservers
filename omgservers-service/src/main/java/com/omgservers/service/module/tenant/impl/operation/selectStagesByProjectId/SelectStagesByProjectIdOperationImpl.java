...
@ApplicationScoped
@AllArgsConstructor
class SelectStagesByProjectIdOperationImpl implements SelectStagesByProjectIdOperation {
    ...
    @Override
    public Uni<List<StageModel>> selectStagesByProjectId(final SqlConnection sqlConnection,
                                                         final int shard,
                                                         final Long tenantId,
        ...
        return selectListOperation.selectList(
                ...
                """
                        ...
                        where tenant_id = $1 and project_id = $2 and deleted = $3
                        """,
                Arrays.asList(
                        tenantId,
                        projectId,
