...
@ApplicationScoped
@AllArgsConstructor
class DeleteTenantLobbyRefOperationImpl implements DeleteTenantLobbyRefOperation {
    ...
    public Uni<Boolean> execute(final ChangeContext<?> changeContext,
        ...
        return changeObjectOperation.changeObject(
                ...
                """
                        update $schema.tab_tenant_lobby_ref
                ...
                () -> new TenantLobbyRefDeletedEventBodyModel(tenantId, id),
                () -> null
        );
    }
}
