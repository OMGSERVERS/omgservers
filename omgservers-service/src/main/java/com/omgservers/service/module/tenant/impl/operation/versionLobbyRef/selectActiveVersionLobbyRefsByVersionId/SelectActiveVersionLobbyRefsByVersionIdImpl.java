...
@ApplicationScoped
@AllArgsConstructor
class SelectActiveVersionLobbyRefsByVersionIdImpl implements SelectActiveVersionLobbyRefsByVersionId {
    ...
    @Override
    public Uni<List<VersionLobbyRefModel>> selectActiveVersionLobbyRefsByVersionId(final SqlConnection sqlConnection,
                                                                                   final int shard,
                                                                                   final Long tenantId,
