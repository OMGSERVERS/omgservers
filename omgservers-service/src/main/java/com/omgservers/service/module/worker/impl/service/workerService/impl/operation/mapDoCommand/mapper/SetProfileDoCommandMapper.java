...
public class SetProfileDoCommandMapper implements DoCommandMapper {
    ...
    public EventModel map(Long runtimeId, DoCommandModel doCommand) {
        ...
        final var eventBody = new SetProfileCommandReceivedEventBodyModel(runtimeId, userId, clientId, profile);
