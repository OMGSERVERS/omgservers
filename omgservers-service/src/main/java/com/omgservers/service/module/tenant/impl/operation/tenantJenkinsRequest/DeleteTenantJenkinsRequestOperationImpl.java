...
@ApplicationScoped
@AllArgsConstructor
class DeleteTenantJenkinsRequestOperationImpl implements DeleteTenantJenkinsRequestOperation {
    ...
    public Uni<Boolean> execute(final ChangeContext<?> changeContext,
        ...
        return changeObjectOperation.changeObject(
                ...
                """
                        update $schema.tab_tenant_jenkins_request
                ...
                () -> new TenantJenkinsRequestDeletedEventBodyModel(tenantId, id),
                () -> null
        );
    }
}
