...
@ApplicationScoped
@AllArgsConstructor
class DeleteMatchmakerMatchOperationImpl implements DeleteMatchmakerMatchOperation {
    ...
    @Override
    public Uni<Boolean> deleteMatchmakerMatch(final ChangeContext<?> changeContext,
        ...
        return changeObjectOperation.changeObject(
                ...
                () -> new MatchmakerMatchDeletedEventBodyModel(matchmakerId, id),
                () -> null
        );
    }
}
