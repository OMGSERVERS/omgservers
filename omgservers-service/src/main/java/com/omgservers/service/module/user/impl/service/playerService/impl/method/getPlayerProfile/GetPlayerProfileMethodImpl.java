package com.omgservers.service.module.user.impl.service.playerService.impl.method.getPlayerProfile;
...
import com.omgservers.service.module.user.impl.operation.selectPlayerProfile.SelectPlayerProfileOperation;
...
class GetPlayerProfileMethodImpl implements GetPlayerProfileMethod {
    ...
    public Uni<GetPlayerProfileResponse> getPlayerProfile(final GetPlayerProfileRequest request) {
        log.debug("Get player profile, request={}", request);
