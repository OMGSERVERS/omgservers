...
import com.omgservers.service.module.root.impl.operation.rootEntityRef.selectRootEntityRefByRootIdAndEntityId.SelectRootEntityRefByRootIdAndEntityIdOperation;
...
class FindRootEntityRefMethodImpl implements FindRootEntityRefMethod {
    ...
    public Uni<FindRootEntityRefResponse> findRootEntityRef(
        ...
        log.debug("Find root entity ref request, request={}", request);
