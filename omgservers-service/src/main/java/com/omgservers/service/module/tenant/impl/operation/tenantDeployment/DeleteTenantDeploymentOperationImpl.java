...
@ApplicationScoped
@AllArgsConstructor
class DeleteTenantDeploymentOperationImpl implements DeleteTenantDeploymentOperation {
    ...
    public Uni<Boolean> execute(final ChangeContext<?> changeContext,
        ...
        return changeObjectOperation.changeObject(
                ...
                """
                        update $schema.tab_tenant_deployment
                ...
                () -> new TenantDeploymentDeletedEventBodyModel(tenantId, id),
                () -> null
        );
    }
}
