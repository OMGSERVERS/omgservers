package com.omgservers.service.module.lobby.impl.operation.selectLobbyRuntime;
...
@ApplicationScoped
@AllArgsConstructor
class SelectLobbyRuntimeOperationImpl implements SelectLobbyRuntimeOperation {
    ...
    @Override
    public Uni<LobbyRuntimeModel> selectLobbyRuntime(final SqlConnection sqlConnection,
                                                     final int shard,
                                                     final Long lobbyId,
                                                     final Long id) {
