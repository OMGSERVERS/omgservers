...
class SignUpMessageHandlerImpl implements MessageHandler {
    ...
    public Uni<Void> handle(final Long connectionId, final MessageModel message) {
        log.debug("Handle sign up message, connectionId={}, message={}", connectionId, message);
        ...
        final var eventBody =
                new SignUpMessageReceivedEventBodyModel(serverUri, connectionId, tenantId, stageId, stageSecret);
