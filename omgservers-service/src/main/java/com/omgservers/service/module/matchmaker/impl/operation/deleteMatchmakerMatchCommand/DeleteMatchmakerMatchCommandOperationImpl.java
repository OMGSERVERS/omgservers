...
@ApplicationScoped
@AllArgsConstructor
class DeleteMatchmakerMatchCommandOperationImpl implements DeleteMatchmakerMatchCommandOperation {

    final ChangeObjectOperation changeObjectOperation;
    final LogModelFactory logModelFactory;

    @Override
    public Uni<Boolean> deleteMatchmakerMatchCommand(final ChangeContext<?> changeContext,
