...
@ApplicationScoped
@AllArgsConstructor
class SelectActiveStagePermissionsByTenantIdOperationImpl
        implements SelectActiveStagePermissionsByTenantIdOperation {
    ...
    @Override
    public Uni<List<StagePermissionModel>> selectActiveStagePermissionsByTenantId(
