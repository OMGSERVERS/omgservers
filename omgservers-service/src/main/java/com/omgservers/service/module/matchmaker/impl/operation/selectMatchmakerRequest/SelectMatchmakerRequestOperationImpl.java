package com.omgservers.service.module.matchmaker.impl.operation.selectMatchmakerRequest;
...
class SelectMatchmakerRequestOperationImpl implements SelectMatchmakerRequestOperation {
    ...
    @Override
    public Uni<MatchmakerRequestModel> selectMatchmakerRequest(final SqlConnection sqlConnection,
                                                               final int shard,
