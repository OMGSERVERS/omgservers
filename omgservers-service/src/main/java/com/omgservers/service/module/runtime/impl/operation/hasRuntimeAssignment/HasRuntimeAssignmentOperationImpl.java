package com.omgservers.service.module.runtime.impl.operation.hasRuntimeAssignment;
...
class HasRuntimeAssignmentOperationImpl implements HasRuntimeAssignmentOperation {
    ...
    @Override
    public Uni<Boolean> hasRuntimeAssignment(final SqlConnection sqlConnection,
                                             final int shard,
