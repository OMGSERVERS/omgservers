...
@ApplicationScoped
@AllArgsConstructor
class SelectActiveMatchCommandsByMatchIdOperationImpl
        implements SelectActiveMatchCommandsByMatchIdOperation {
    ...
    @Override
    public Uni<List<MatchCommandModel>> selectActiveMatchCommandsByMatchId(
