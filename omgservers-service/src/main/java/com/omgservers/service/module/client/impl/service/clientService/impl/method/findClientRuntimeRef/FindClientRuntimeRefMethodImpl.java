package com.omgservers.service.module.client.impl.service.clientService.impl.method.findClientRuntimeRef;
...
import com.omgservers.service.module.client.impl.operation.selectClientRuntimeRefByClientIdAndRuntimeId.SelectClientRuntimeRefByClientIdAndRuntimeIdOperation;
...
class FindClientRuntimeRefMethodImpl implements FindClientRuntimeRefMethod {
    ...
    public Uni<FindClientRuntimeRefResponse> findClientRuntimeRef(final FindClientRuntimeRefRequest request) {
        log.debug("Find client runtime ref, request={}", request);
