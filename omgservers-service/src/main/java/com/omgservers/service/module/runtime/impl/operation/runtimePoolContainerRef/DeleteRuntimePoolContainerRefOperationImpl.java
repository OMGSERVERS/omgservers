...
@ApplicationScoped
@AllArgsConstructor
class DeleteRuntimePoolContainerRefOperationImpl implements DeleteRuntimePoolContainerRefOperation {
    ...
    public Uni<Boolean> execute(final ChangeContext<?> changeContext,
        ...
        return changeObjectOperation.changeObject(
                ...
                """
                        update $schema.tab_runtime_pool_container_ref
                ...
                () -> new RuntimePoolContainerRefDeletedEventBodyModel(runtimeId, id),
                () -> null
        );
    }
}
