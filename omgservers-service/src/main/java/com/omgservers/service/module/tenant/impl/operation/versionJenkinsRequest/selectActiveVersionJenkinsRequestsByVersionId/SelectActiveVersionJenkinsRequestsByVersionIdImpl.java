...
@ApplicationScoped
@AllArgsConstructor
class SelectActiveVersionJenkinsRequestsByVersionIdImpl implements SelectActiveVersionJenkinsRequestsByVersionId {
    ...
    @Override
    public Uni<List<VersionJenkinsRequestModel>> selectActiveVersionJenkinsRequestsByVersionId(
