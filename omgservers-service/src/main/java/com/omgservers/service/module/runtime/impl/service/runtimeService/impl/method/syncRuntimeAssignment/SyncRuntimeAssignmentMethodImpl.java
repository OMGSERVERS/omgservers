package com.omgservers.service.module.runtime.impl.service.runtimeService.impl.method.syncRuntimeAssignment;
...
import com.omgservers.service.module.runtime.impl.operation.upsertRuntimeAssignment.UpsertRuntimeAssignmentOperation;
...
class SyncRuntimeAssignmentMethodImpl implements SyncRuntimeAssignmentMethod {
    ...
    public Uni<SyncRuntimeAssignmentResponse> syncRuntimeAssignment(final SyncRuntimeAssignmentRequest request) {
        log.debug("Sync runtime assignment, request={}", request);
                ...
                .flatMap(shardModel -> {
                    ...
                    return changeWithContextOperation.<Boolean>changeWithContext(
                                    (changeContext, sqlConnection) -> hasRuntimeOperation
                                            ...
                                            .flatMap(has -> {
                                                if (has) {
                                                    return upsertRuntimeAssignmentOperation.upsertRuntimeAssignment(
                                                            changeContext,
                                                            sqlConnection,
                                                            shardModel.shard(),
                                                            runtimeAssignment);
