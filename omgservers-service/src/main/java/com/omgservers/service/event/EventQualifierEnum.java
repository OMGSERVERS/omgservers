...
public enum EventQualifierEnum {
    ...
    TENANT_LOBBY_RESOURCE_CREATED(TenantLobbyResourceCreatedEventBodyModel.class),
    TENANT_LOBBY_RESOURCE_DELETED(TenantLobbyResourceDeletedEventBodyModel.class),
    ...
    TENANT_MATCHMAKER_RESOURCE_CREATED(TenantMatchmakerResourceCreatedEventBodyModel.class),
    TENANT_MATCHMAKER_RESOURCE_DELETED(TenantMatchmakerResourceDeletedEventBodyModel.class),
