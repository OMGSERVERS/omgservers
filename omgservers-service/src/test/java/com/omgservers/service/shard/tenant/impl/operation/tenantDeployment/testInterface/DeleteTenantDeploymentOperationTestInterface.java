...
import com.omgservers.service.shard.tenant.impl.operation.tenantDeployment.DeleteTenantDeploymentOperation;
...
@ApplicationScoped
@AllArgsConstructor
public class DeleteTenantDeploymentOperationTestInterface {
    ...
    public ChangeContext<Boolean> execute(final Long tenantId,
        ...
        return Uni.createFrom().context(context -> {
                    ...
                    return pgPool.withTransaction(sqlConnection -> deleteTenantDeploymentOperation
