...
class UpsertMatchmakerRequestOperationTest extends BaseTestClass {
    ...
    void givenModel_whenExecute_thenInserted() {
        ...
        final var changeContext = upsertMatchmakerRequestOperation.upsertMatchmakerRequest(model);
    ...
    void givenModel_whenExecute_thenException() {
        ...
        assertThrows(ServerSideBadRequestException.class, () -> upsertMatchmakerRequestOperation
                .upsertMatchmakerRequest(model));
    }
    ...
    void givenModel_whenExecute_thenIdempotencyViolation() {
        ...
        final var exception = assertThrows(ServerSideConflictException.class, () ->
                upsertMatchmakerRequestOperation.upsertMatchmakerRequest(model));
