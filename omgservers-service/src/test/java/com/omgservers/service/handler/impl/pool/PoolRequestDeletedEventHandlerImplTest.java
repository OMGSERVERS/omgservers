...
import com.omgservers.service.handler.impl.pool.testInterface.PoolRequestDeletedEventHandlerImplTestInterface;
...
@Slf4j
@QuarkusTest
class PoolRequestDeletedEventHandlerImplTest extends BaseTestClass {
    ...
    void givenHandler_whenRetry_thenFinished() {
        ...
        poolService.execute(deletePoolRequestRequest);
