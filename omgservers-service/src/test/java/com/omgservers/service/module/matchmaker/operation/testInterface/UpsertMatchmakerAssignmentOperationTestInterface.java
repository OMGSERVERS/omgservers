...
import com.omgservers.service.module.matchmaker.impl.operation.upsertMatchmakerAssignment.UpsertMatchmakerAssignmentOperation;
    ...
    public ChangeContext<Boolean> upsertMatchmakerAssignment(final int shard,
        ...
        return Uni.createFrom().context(context -> {
                    ...
                    return pgPool.withTransaction(sqlConnection -> upsertMatchmakerAssignmentOperation
                                    .upsertMatchmakerAssignment(changeContext, sqlConnection, shard, matchmakerAssignment))
