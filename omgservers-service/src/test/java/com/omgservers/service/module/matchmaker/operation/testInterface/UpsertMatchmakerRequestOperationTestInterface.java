...
import com.omgservers.service.module.matchmaker.impl.operation.upsertMatchmakerRequest.UpsertMatchmakerRequestOperation;
    ...
    public ChangeContext<Boolean> upsertMatchmakerRequest(final int shard,
        ...
        return Uni.createFrom().context(context -> {
                    ...
                    return pgPool.withTransaction(sqlConnection -> upsertRequestOperation
                                    .upsertMatchmakerRequest(changeContext, sqlConnection, shard, matchmakerRequest))
