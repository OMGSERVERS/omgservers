package com.omgservers.service.server.service.bootstrap.impl.method.bootstrapRouterUser;
...
@ApplicationScoped
@AllArgsConstructor
class BootstrapRouterUserMethodImpl implements BootstrapRouterUserMethod {
    ...
    public Uni<Void> bootstrapRouterUser() {
        log.debug("Bootstrap router user");

        final var userId = getConfigOperation.getServiceConfig().defaults().routerUserId();
