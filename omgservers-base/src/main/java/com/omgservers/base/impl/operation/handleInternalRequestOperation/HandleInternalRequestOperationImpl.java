package com.omgservers.base.impl.operation.handleInternalRequestOperation;
...
class HandleInternalRequestOperationImpl implements HandleInternalRequestOperation {
    ...
    @Override
    public <T extends InternalRequest, R, C> Uni<R> handleInternalRequest(final Logger log,
                                                                          final T request,
