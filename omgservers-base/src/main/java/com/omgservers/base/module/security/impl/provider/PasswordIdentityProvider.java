package com.omgservers.base.module.security.impl.provider;
...
class PasswordIdentityProvider implements IdentityProvider<UsernamePasswordAuthenticationRequest> {
    ...
    public Uni<SecurityIdentity> authenticate(UsernamePasswordAuthenticationRequest request,
        ...
        if (username.equals(getConfigOperation.getConfig().adminUsername())) {
            ...
            return internalModule.getServiceAccountService().validateCredentials(validateCredentialsInternalRequest)
