...
public class ChangeLuaCommandMapper implements LuaCommandMapper {

    @Override
    public LuaCommandQualifierEnum getQualifier() {
        return LuaCommandQualifierEnum.CHANGE;
    }
    ...
    public DoCommandModel map(LuaTable luaCommand) {
        ...
        final var doCommandBody = new DoChangeCommandBodyModel(userId, clientId, luaMessage);
        final var doCommandModel = new DoCommandModel(DoCommandQualifierEnum.DO_CHANGE, doCommandBody);
