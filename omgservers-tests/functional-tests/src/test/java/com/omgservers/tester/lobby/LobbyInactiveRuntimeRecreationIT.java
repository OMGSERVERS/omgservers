...
//            final var lobbyRuntimeId1 = ((RuntimeAssignedMessageBodyDto) lobbyAssignment1.getBody())
//                    .getRuntimeId();
...
//                    ((ClientDeletedMessageBodyDto) disconnectionMessage1.getBody()).getReason());
//
...
//
//            final var lobbyRuntimeId2 = ((RuntimeAssignedMessageBodyDto) lobbyAssignment2.getBody())
//                    .getRuntimeId();
