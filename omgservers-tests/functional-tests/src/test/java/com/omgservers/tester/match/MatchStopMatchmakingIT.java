...
//
//            final var runtimeId1 = ((RuntimeAssignedMessageBodyDto) matchAssignment1.getBody()).getRuntimeId();
//
...
//
//            final var runtimeId2 = ((RuntimeAssignedMessageBodyDto) matchAssignment2.getBody()).getRuntimeId();
//
